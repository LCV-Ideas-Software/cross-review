...
// the six-provider audit.
{
  ...
  // v06.00.00 / issue #271: the retired Claude pin is a strict PREFIX of the new
  ...
  assert.equal(
    stalePrefixLie.pass,
    false,
    "v06.00.00 / truthfulness: the retired claude-fable-5 pin must contradict the claude-fable-5-1 pin (stale prefix, not a family hit)",
  );
  ...
  assert.equal(
    wholePinTruth.pass,
    true,
    "v06.00.00 / truthfulness: the whole claude-fable-5-1 token must match the pin",
  );
  ...
  assert.equal(
    ...
    true,
    "v06.00.00 / truthfulness: a truthful routed openai/gpt-6-astra Perplexity pin must pass",
  );
  assert.equal(
    truthfulnessPreflight({
      task: "Check the currently loaded cross-review runtime perplexity model.",
    ...
    false,
    "v06.00.00 / truthfulness: a wrong routed model must still contradict the openai/gpt-6-astra pin",
  );
  assert.equal(
    truthfulnessPreflight({
    ...
    true,
    "v06.00.00 / truthfulness: the native codex claim keeps matching its own gpt-6-astra pin next to the routed Perplexity pin",
  );
  ...
  for (const futureTarget of [
    ...
    "The cross-review runtime will replace the Claude model with claude-mythos-5.",
    "The cross-review runtime will update the Claude model to claude-mythos-5.",
    "The cross-review runtime plans to adopt claude-mythos-5; it currently uses feature flags for routing.",
    "The cross-review runtime plans to adopt claude-mythos-5; Claude currently uses feature flags for routing.",
    "The cross-review runtime plans to adopt claude-mythos-5, but the runtime currently uses feature flags for routing.",
    "O runtime do cross-review pretende adotar claude-mythos-5; ele usa feature flags atualmente.",
    "The current cross-review runtime Claude model pretende adotar claude-mythos-5, mas o runtime atualmente usa feature flags.",
    "O runtime do cross-review pretende adotar claude-mythos-5, que ele usará na próxima versão.",
    "The current cross-review runtime Claude model pretende adotar claude-mythos-5, que ele seleciona para a próxima versão.",
  ]) {
    assert.equal(
  ...
  for (const currentLie of [
    ...
    "The current cross-review runtime Claude model pretende adotar claude-mythos-5, que ele seleciona para a próxima versão e ele está atualmente ativo no runtime.",
    ...
    "The cross-review runtime plans to adopt claude-mythos-5; it is the current model.",
    "The cross-review runtime plans to adopt claude-mythos-5; it currently uses it.",
    "The cross-review runtime plans to adopt claude-mythos-5; Claude currently uses it.",
    "The cross-review runtime plans to adopt claude-mythos-5, but Claude currently uses it.",
    "The current cross-review runtime Claude model pretende adotar claude-mythos-5; ele é o modelo atual.",
    ...
    "The current cross-review runtime Claude model pretende adotar claude-mythos-5, que ele usa atualmente.",
    "The cross-review runtime plans to adopt claude-mythos-5, which it currently uses.",
    "The current cross-review runtime Claude model pretende adotar claude-mythos-5, que ele seleciona atualmente.",
    "The current cross-review runtime replaced the Claude model with claude-mythos-5.",
