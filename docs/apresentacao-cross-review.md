...
| ---------------- | ------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `v04.06.05`      | 01/09/2026    | Preserves READY for 20 path+digest+literal sources whose GitHub URLs differ only by provider JSON escaping; the official Git parser preserves exact unified-diff paths across rapporteur rounds without admitting invented URLs, crossed quotes, ambiguous paths, or absent files.                                    |
