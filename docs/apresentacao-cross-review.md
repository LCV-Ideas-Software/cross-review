...
| Versão preparada pelo source  | `v04.05.34`                        |
...
| ---------------- | ------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `v04.05.34`      | 2026-08-03    | Remove duas expressões redundantes apontadas pelo GitHub Code Quality, preservando o comportamento do preflight de orçamento e o fallback tardio de anexos quando o preflight de veracidade está desativado.                                                           |
