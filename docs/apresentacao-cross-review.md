...
| Versão preparada pelo source  | `v04.06.09`                        |
...
| ---------------- | ------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `v04.06.09`      | 05/09/2026    | Dimensões Sonar legadas removidas do custo e das fixtures; as chaves seguem aceitas pelo schema como obsoletas e ignoradas, nomeadas no boot; config central rejeitada pelo schema passa a ser avisada no boot.                                                                                                       |
