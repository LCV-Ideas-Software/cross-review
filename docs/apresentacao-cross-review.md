...
| Versão preparada pelo source  | `v04.07.00`                        |
...
| ---------------- | ------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `v04.07.00`      | 24/08/2026    | Cache explícito opcional do Gemini (CROSREV-6, issue #185): a cabeça estável do prompt de review vira `cachedContents` com custo de armazenamento determinístico por token-hora; opt-in por `CROSS_REVIEW_GEMINI_EXPLICIT_CACHE` e exigido pelo gate financeiro quando armado.                                        |
