...
>
> Estado do source/release target em 01/09/2026: `4.6.5`. O registro pode ficar
...
| Versão           | Marco                                                                                                                                                                                                                                                                                                                 |
| ---------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `v04.06.05`      | Preserves READY for 20 path+digest+literal sources whose GitHub URLs differ only by provider JSON escaping; the official Git parser preserves exact unified-diff paths across rapporteur rounds without admitting invented URLs, crossed quotes, ambiguous paths, or absent files.                                    |
