...
| Versão           | Marco                                                                                                                                                                                                                                                                                                                 |
| ---------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `v04.06.05`      | Preserves READY for 20 path+digest+literal sources whose GitHub URLs differ only by provider JSON escaping and maintains unified-patch file custody across rapporteur rounds, without admitting invented URLs, cross-sourced quotes, or missing files.                                                                |
