...
>
> Estado do source/release target em 05/09/2026: `4.6.9`. O registro pode ficar
...
| Versão           | Marco                                                                                                                                                                                                                                                                                                                 |
| ---------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `v04.06.09`      | Dimensões Sonar legadas removidas do custo e das fixtures; as chaves seguem aceitas pelo schema como obsoletas e ignoradas, nomeadas no boot; config central rejeitada pelo schema passa a ser avisada no boot.                                                                                                       |
