...
| Versão           | Marco                                                                                                                                                                                                                                                                                                                 |
| ---------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `v04.06.09`      | Dimensões Sonar legadas removidas do custo; as chaves seguem aceitas pelo schema como obsoletas e ignoradas, nomeadas no boot; config central rejeitada pelo schema passa a ser avisada no boot.                                                                                                                      |
