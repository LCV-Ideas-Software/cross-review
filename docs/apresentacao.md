...
>
> Estado do source/release target em 07/09/2026: `6.0.0`. O registro pode ficar
...
| Versão           | Marco                                                                                                                                                                                                                                                                                                                 |
| ---------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `v06.00.00`      | Versão maior: Claude Fable 5.1 e GPT-6 Astra viram os peers padrão, o pin primário exige cartão de preço de id exato, `gpt-5.6-sol` / `claude-fable-5` são varridos, e as chaves Sonar legadas voltam a ser rejeitadas, como agendado na v05.00.00.                                                                   |
