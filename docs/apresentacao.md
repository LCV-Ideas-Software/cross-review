...
| Versão           | Marco                                                                                                                                                                                                                                  |
| ---------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `v04.05.39`      | Impede retry de recuperação de caller token no mesmo boot, recria somente após desaparecimento confirmado e exige que a receita manual valide a DACL protegida e exata antes do restart.                                               |
