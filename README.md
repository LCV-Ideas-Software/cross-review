...
| Release              | Scope                                                                                                                                                                                                                                                                                 |
| -------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **`v04.06.05`**      | Uses Git's official parser for exact unified-diff paths, preserves contextual JSON quote escapes, and fails closed on fabricated URLs, ambiguous paths, or unavailable validation.                                                                                                    |
