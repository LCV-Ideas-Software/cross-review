...
| Release              | Scope                                                                                                                                                                                                                                                                                                                               |
| -------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **`v06.00.00`**      | **Major: flagship pins refreshed, exact-card pricing, Sonar keys rejected.** Claude Fable 5.1 and GPT-6 Astra become the default peers, the primary pin is priced only by an exact-id rate card, `gpt-5.6-sol` / `claude-fable-5` are swept, and the five legacy Sonar rate-card keys are rejected again as scheduled in v05.00.00. |
