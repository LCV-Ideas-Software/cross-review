...
**Status.** Stable. The current source/release target is **v04.05.39** (package `4.5.39`).
...
| Release              | Scope                                                                                                                                                                                                                                                                            |
| -------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **`v04.05.39`**      | Prevents repeated caller-token permission recovery in one boot, regenerates only after a confirmed disappearance, and makes the trusted-console Windows recipe verify the exact protected DACL before restart.                                                                   |
