...
**Status.** Stable. The current source/release target is **v04.06.09** (package `4.6.9`).
...
| Release              | Scope                                                                                                                                                                                                                                                                                 |
| -------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **`v04.06.09`**      | **Legacy Sonar dimensions removed.** The five Sonar-only rate-card keys leave the cost engine and fixtures and stay accepted by the schema as deprecated no-ops named at boot; a central config the schema rejects is now announced at boot.                                          |
