...
| Release              | Scope                                                                                                                                                                                                                                                                                 |
| -------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **`v05.01.00`**      | **Flagship pins refreshed.** Claude Fable 5.1 and GPT-6 Astra become the default peers, the primary pin requires an exact-id rate card, and `gpt-5.6-sol` / `claude-fable-5` are swept.                                                                                               |
